...
# Add these decorators to your complete_technical_seo_agents.py file
...
@router.post("/xml_sitemap_validator")
async def api_xml_sitemap_validator(sitemap_url: str = Body(...)):
    try:
        result = await xml_sitemap_validator(sitemap_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/robots_txt_audit")
async def api_robots_txt_audit(site_url: str = Body(...)):
    try:
        result = await robots_txt_audit(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))
...
async def api_mobile_usability_check(site_url: str = Body(...)):
    try:
        result = await mobile_usability_check(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/redirect_chain_checker")
async def api_redirect_chain_checker(url: str = Body(...)):
    try:
        result = await redirect_chain_checker(url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/ssl_certificate_checker")
async def api_ssl_certificate_checker(domain: str = Body(...)):
    try:
        result = await ssl_certificate_checker(domain)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/crawl_budget_analyzer")
async def api_crawl_budget_analyzer(site_url: str = Body(...)):
    try:
        result = await crawl_budget_analyzer(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/crawl_frequency_optimizer")
async def api_crawl_frequency_optimizer(site_url: str = Body(...)):
    try:
        result = await crawl_frequency_optimizer(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/index_coverage_report")
async def api_index_coverage_report(site_url: str = Body(...)):
    try:
        result = await index_coverage_report(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/indexing_errors_detector")
async def api_indexing_errors_detector(site_url: str = Body(...)):
    try:
        result = await indexing_errors_detector(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/noindex_tag_finder")
async def api_noindex_tag_finder(site_url: str = Body(...)):
    try:
        result = await noindex_tag_finder(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/meta_robots_auditor")
async def api_meta_robots_auditor(site_url: str = Body(...)):
    try:
        result = await meta_robots_auditor(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/block_resources_detector")
async def api_block_resources_detector(site_url: str = Body(...)):
    try:
        result = await block_resources_detector(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/duplicate_content_finder")
async def api_duplicate_content_finder(site_url: str = Body(...)):
    try:
        result = await duplicate_content_finder(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/canonicalization_checker")
async def api_canonicalization_checker(site_url: str = Body(...)):
    try:
        result = await canonicalization_checker(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/hreflang_validator")
async def api_hreflang_validator(site_url: str = Body(...)):
    try:
        result = await hreflang_validator(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/soft_404_detector")
async def api_soft_404_detector(site_url: str = Body(...)):
    try:
        result = await soft_404_detector(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/infinite_loop_detector")
async def api_infinite_loop_detector(site_url: str = Body(...)):
    try:
        result = await infinite_loop_detector(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/self_referencing_canonical")
async def api_self_referencing_canonical(site_url: str = Body(...)):
    try:
        result = await self_referencing_canonical(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/orphaned_pages_finder")
async def api_orphaned_pages_finder(site_url: str = Body(...)):
    try:
        result = await orphaned_pages_finder(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/crawlable_links_checker")
async def api_crawlable_links_checker(site_url: str = Body(...)):
    try:
        result = await crawlable_links_checker(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/ajax_crawlability_tester")
async def api_ajax_crawlability_tester(site_url: str = Body(...)):
    try:
        result = await ajax_crawlability_tester(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/broken_links_detector")
async def api_broken_links_detector(site_url: str = Body(...)):
    try:
        result = await broken_links_detector(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/internal_links_audit")
async def api_internal_links_audit(site_url: str = Body(...)):
    try:
        result = await internal_links_audit(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/anchor_text_analyzer")
async def api_anchor_text_analyzer(site_url: str = Body(...)):
    try:
        result = await anchor_text_analyzer(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/page_depth_analyzer")
async def api_page_depth_analyzer(site_url: str = Body(...)):
    try:
        result = await page_depth_analyzer(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/crawl_speed_monitor")
async def api_crawl_speed_monitor(site_url: str = Body(...)):
    try:
        result = await crawl_speed_monitor(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

# SECTION 2: SITE STRUCTURE & URLS (16 AGENTS)

@router.post("/internal_link_structure")
async def api_internal_link_structure(site_url: str = Body(...)):
    try:
        result = await internal_link_structure(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/url_parameter_analysis")
async def api_url_parameter_analysis(site_url: str = Body(...)):
    try:
        result = await url_parameter_analysis(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/url_structure_optimization")
async def api_url_structure_optimization(site_url: str = Body(...)):
    try:
        result = await url_structure_optimization(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/canonicalization_audit")
async def api_canonicalization_audit(site_url: str = Body(...)):
    try:
        result = await canonicalization_audit(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

'''@router.post("/url_canonicalization")
async def api_url_canonicalization(site_url: str = Body(...)):
    try:
        result = await url_canonicalization(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/long_url_detector")
async def api_long_url_detector(site_url: str = Body(...)):
    try:
        result = await long_url_detector(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))'''

@router.post("/dynamic_url_patterns")
async def api_dynamic_url_patterns(site_url: str = Body(...)):
    try:
        result = await dynamic_url_patterns(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/session_id_detector")
async def api_session_id_detector(site_url: str = Body(...)):
    try:
        result = await session_id_detector(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/url_keyword_optimization")
async def api_url_keyword_optimization(site_url: str = Body(...)):
    try:
        result = await url_keyword_optimization(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/subdomain_structure")
async def api_subdomain_structure(site_url: str = Body(...)):
    try:
        result = await subdomain_structure(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/subfolder_organization")
async def api_subfolder_organization(site_url: str = Body(...)):
    try:
        result = await subfolder_organization(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/url_consistency_checker")
async def api_url_consistency_checker(site_url: str = Body(...)):
    try:
        result = await url_consistency_checker(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/parameterized_url_rewrite")
async def api_parameterized_url_rewrite(site_url: str = Body(...)):
    try:
        result = await parameterized_url_rewrite(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/query_string_analyzer")
async def api_query_string_analyzer(site_url: str = Body(...)):
    try:
        result = await query_string_analyzer(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/trailing_slash_checker")
async def api_trailing_slash_checker(site_url: str = Body(...)):
    try:
        result = await trailing_slash_checker(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/url_encoding_validator")
async def api_url_encoding_validator(site_url: str = Body(...)):
    try:
        result = await url_encoding_validator(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))
...
@router.post("/core_web_vitals_analyzer")
async def api_core_web_vitals_analyzer(url: str = Body(...)):
    try:
        result = await core_web_vitals_analyzer(url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/first_contentful_paint")
async def api_first_contentful_paint(url: str = Body(...)):
    try:
        result = await first_contentful_paint(url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/largest_contentful_paint")
async def api_largest_contentful_paint(url: str = Body(...)):
    try:
        result = await largest_contentful_paint(url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/first_input_delay")
async def api_first_input_delay(url: str = Body(...)):
    try:
        result = await first_input_delay(url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/cumulative_layout_shift")
async def api_cumulative_layout_shift(url: str = Body(...)):
    try:
        result = await cumulative_layout_shift(url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/time_to_first_byte")
async def api_time_to_first_byte(url: str = Body(...)):
    try:
        result = await time_to_first_byte(url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/total_blocking_time")
async def api_total_blocking_time(url: str = Body(...)):
    try:
        result = await total_blocking_time(url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/resource_loading_time")
async def api_resource_loading_time(url: str = Body(...)):
    try:
        result = await resource_loading_time(url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/javascript_execution_time")
async def api_javascript_execution_time(url: str = Body(...)):
    try:
        result = await javascript_execution_time(url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/css_rendering_time")
async def api_css_rendering_time(url: str = Body(...)):
    try:
        result = await css_rendering_time(url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/image_optimization_check")
async def api_image_optimization_check(url: str = Body(...)):
    try:
        result = await image_optimization_check(url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/compression_analyzer")
async def api_compression_analyzer(url: str = Body(...)):
    try:
        result = await compression_analyzer(url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))
...
@router.post("/responsive_design_check")
async def api_responsive_design_check(url: str = Body(...)):
    try:
        result = await responsive_design_check(url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/accessibility_audit")
async def api_accessibility_audit(url: str = Body(...)):
    try:
        result = await accessibility_audit(url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/heading_hierarchy_checker")
async def api_heading_hierarchy_checker(url: str = Body(...)):
    try:
        result = await heading_hierarchy_checker(url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/alt_text_analyzer")
async def api_alt_text_analyzer(url: str = Body(...)):
    try:
        result = await alt_text_analyzer(url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/form_accessibility_check")
async def api_form_accessibility_check(url: str = Body(...)):
    try:
        result = await form_accessibility_check(url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/color_contrast_validator")
async def api_color_contrast_validator(url: str = Body(...)):
    try:
        result = await color_contrast_validator(url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/keyboard_navigation_tester")
async def api_keyboard_navigation_tester(url: str = Body(...)):
    try:
        result = await keyboard_navigation_tester(url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/screen_reader_compatibility")
async def api_screen_reader_compatibility(url: str = Body(...)):
    try:
        result = await screen_reader_compatibility(url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))
...
@router.post("/https_implementation")
async def api_https_implementation(domain: str = Body(...)):
    try:
        result = await https_implementation(domain)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/ssl_certificate_checker_agent")
async def api_ssl_certificate_checker_agent(domain: str = Body(...)):
    try:
        result = await ssl_certificate_checker_agent(domain)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/certificate_expiry_monitor")
async def api_certificate_expiry_monitor(domain: str = Body(...)):
    try:
        result = await certificate_expiry_monitor(domain)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/security_headers_check")
async def api_security_headers_check(url: str = Body(...)):
    try:
        result = await security_headers_check(url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/x_frame_options_validator")
async def api_x_frame_options_validator(url: str = Body(...)):
    try:
        result = await x_frame_options_validator(url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/x_content_type_options")
async def api_x_content_type_options(url: str = Body(...)):
    try:
        result = await x_content_type_options(url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/strict_transport_security")
async def api_strict_transport_security(url: str = Body(...)):
    try:
        result = await strict_transport_security(url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/content_security_policy")
async def api_content_security_policy(url: str = Body(...)):
    try:
        result = await content_security_policy(url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/mixed_content_detector")
async def api_mixed_content_detector(url: str = Body(...)):
    try:
        result = await mixed_content_detector(url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/ssl_protocol_validator")
async def api_ssl_protocol_validator(domain: str = Body(...)):
    try:
        result = await ssl_protocol_validator(domain)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))
...
@router.post("/schema_markup_validator")
async def api_schema_markup_validator(pages: Dict[str, str] = Body(...)):
    try:
        result = await schema_markup_validator(pages)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
...
@router.post("/structured_data_testing")
async def api_structured_data_testing(url: str = Body(...)):
    try:
        result = await structured_data_testing(url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/organization_schema")
async def api_organization_schema(site_url: str = Body(...)):
    try:
        result = await organization_schema(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/product_schema_validator")
async def api_product_schema_validator(url: str = Body(...)):
    try:
        result = await product_schema_validator(url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/article_schema_checker")
async def api_article_schema_checker(url: str = Body(...)):
    try:
        result = await article_schema_checker(url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/breadcrumb_schema_audit")
async def api_breadcrumb_schema_audit(url: str = Body(...)):
    try:
        result = await breadcrumb_schema_audit(url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/faq_schema_validator")
async def api_faq_schema_validator(url: str = Body(...)):
    try:
        result = await faq_schema_validator(url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/event_schema_checker")
async def api_event_schema_checker(url: str = Body(...)):
    try:
        result = await event_schema_checker(url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/recipe_schema_validator")
async def api_recipe_schema_validator(url: str = Body(...)):
    try:
        result = await recipe_schema_validator(url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/local_business_schema")
async def api_local_business_schema(site_url: str = Body(...)):
    try:
        result = await local_business_schema(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/video_schema_checker")
async def api_video_schema_checker(url: str = Body(...)):
    try:
        result = await video_schema_checker(url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/image_schema_validator")
async def api_image_schema_validator(url: str = Body(...)):
    try:
        result = await image_schema_validator(url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/review_schema_audit")
async def api_review_schema_audit(url: str = Body(...)):
    try:
        result = await review_schema_audit(url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/aggregate_rating_checker")
async def api_aggregate_rating_checker(url: str = Body(...)):
    try:
        result = await aggregate_rating_checker(url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/person_schema_validator")
async def api_person_schema_validator(url: str = Body(...)):
    try:
        result = await person_schema_validator(url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))
...
@router.post("/hreflang_implementation")
async def api_hreflang_implementation(site_url: str = Body(...)):
    try:
        result = await hreflang_implementation(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/hreflang_validator_agent")
async def api_hreflang_validator_agent(site_url: str = Body(...)):
    try:
        result = await hreflang_validator_agent(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/language_meta_checker")
async def api_language_meta_checker(site_url: str = Body(...)):
    try:
        result = await language_meta_checker(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/geo_targeting_validator")
async def api_geo_targeting_validator(site_url: str = Body(...)):
    try:
        result = await geo_targeting_validator(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/language_redirect_tester")
async def api_language_redirect_tester(site_url: str = Body(...)):
    try:
        result = await language_redirect_tester(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/international_pagination")
async def api_international_pagination(site_url: str = Body(...)):
    try:
        result = await international_pagination(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/language_selector_audit")
async def api_language_selector_audit(site_url: str = Body(...)):
    try:
        result = await language_selector_audit(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/dns_prefetch_checker")
async def api_dns_prefetch_checker(site_url: str = Body(...)):
    try:
        result = await dns_prefetch_checker(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/content_language_consistency")
async def api_content_language_consistency(site_url: str = Body(...)):
    try:
        result = await content_language_consistency(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/locale_parameter_checker")
async def api_locale_parameter_checker(site_url: str = Body(...)):
    try:
        result = await locale_parameter_checker(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))
...
@router.post("/crawl_stats_tracker")
async def api_crawl_stats_tracker(site_url: str = Body(...)):
    try:
        result = await crawl_stats_tracker(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/index_coverage_tracker")
async def api_index_coverage_tracker(site_url: str = Body(...)):
    try:
        result = await index_coverage_tracker(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/error_tracking_system")
async def api_error_tracking_system(site_url: str = Body(...)):
    try:
        result = await error_tracking_system(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/performance_trends_analyzer")
async def api_performance_trends_analyzer(site_url: str = Body(...)):
    try:
        result = await performance_trends_analyzer(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/uptime_monitor")
async def api_uptime_monitor(site_url: str = Body(...)):
    try:
        result = await uptime_monitor(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/downtime_detector")
async def api_downtime_detector(site_url: str = Body(...)):
    try:
        result = await downtime_detector(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/spike_detector")
async def api_spike_detector(site_url: str = Body(...)):
    try:
        result = await spike_detector(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/trending_errors_finder")
async def api_trending_errors_finder(site_url: str = Body(...)):
    try:
        result = await trending_errors_finder(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/seo_dashboard_generator")
async def api_seo_dashboard_generator(site_url: str = Body(...)):
    try:
        result = await seo_dashboard_generator(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/alert_system")
async def api_alert_system(site_url: str = Body(...)):
    try:
        result = await alert_system(site_url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

# SECTION 9: ADVANCED CRAWLING (5 AGENTS)

@router.post("/javascript_rendering_audit")
async def api_javascript_rendering_audit(url: str = Body(...)):
    try:
        result = await javascript_rendering_audit(url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/dynamic_content_checker")
async def api_dynamic_content_checker(url: str = Body(...)):
    try:
        result = await dynamic_content_checker(url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/prerender_service_tester")
async def api_prerender_service_tester(url: str = Body(...)):
    try:
        result = await prerender_service_tester(url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/fetch_as_googlebot")
async def api_fetch_as_googlebot(url: str = Body(...)):
    try:
        result = await fetch_as_googlebot(url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

@router.post("/mobile_vs_desktop_comparison")
async def api_mobile_vs_desktop_comparison(url: str = Body(...)):
    try:
        result = await mobile_vs_desktop_comparison(url)
        return {"status": "SUCCESS", "result": result}
    except Exception as e:
...
async def get_status():
    return {
        ...
        "total_agents": 115,
        "total_endpoints": 116,
        "service": "Technical SEO Agents API"
    }
